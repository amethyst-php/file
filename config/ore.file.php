...
return [
    ...
    */
    ...
    |
    */
    'entity' => Railken\LaraOre\File\File::class,
    ...
    |
    */
    'manager' => Railken\LaraOre\File\FileManager::class,
    ...
    |
    */
    'repository' => Railken\LaraOre\File\FileRepository::class,
    ...
    |
    */
    'serializer' => Railken\LaraOre\File\FileSerializer::class,
    ...
    |
    */
    'validator' => Railken\LaraOre\File\FileValidator::class,
    ...
    |
    */
    'authorizer' => Railken\LaraOre\File\FileAuthorizer::class,
    ...
    */
    'http' => [
        'admin' => [
            'enabled'    => true,
            'controller' => Railken\LaraOre\Http\Controllers\Admin\FilesController::class,
            'router'     => [
                'prefix'      => '/admin/files',
            ],
        ],
